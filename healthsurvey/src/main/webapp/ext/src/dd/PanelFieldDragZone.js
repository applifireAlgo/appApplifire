Ext.define('Ext.dd.PanelFieldDragZone', {

    extend: 'Ext.dd.DragZone',

    constructor: function(cfg){
    	alert("In PanelFieldDragZone");
        cfg = cfg || {};
        if (cfg.ddGroup) {
...
//  Call the DRagZone's constructor. The Panel must have been rendered.
    init: function(panel) {
        ...
        if (panel.nodeType) {
            ...
            Ext.dd.PanelFieldDragZone.superclass.init.apply(this, arguments);
        }
        // Panel is a Component - need the el
        else {
            // Called via plugin::init
            if (panel.rendered) {
                Ext.dd.PanelFieldDragZone.superclass.constructor.call(this, panel.getEl());
            } else {
