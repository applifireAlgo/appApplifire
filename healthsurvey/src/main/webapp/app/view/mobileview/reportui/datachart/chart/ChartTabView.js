Ext.define('Healthsurvey.view.mobileview.reportui.datachart.chart.ChartTabView', {
	extend : 'Ext.panel.Panel',
	requires:['Healthsurvey.view.mobileview.reportui.datachart.chart.RatingField','Healthsurvey.view.mobileview.reportui.datachart.chart.ChartController'],
	xtype : 'chart-tabView',
