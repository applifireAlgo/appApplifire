Ext
		.define(
				'Healthsurvey.view.mobileview.reportui.querycriteria.QueryCriteriaView',
				{
					extend : 'Ext.panel.Panel',
					requires : [ 'Healthsurvey.view.mobileview.reportui.querycriteria.QueryCriteriaController' ],
					xtype : 'querycriteria',
