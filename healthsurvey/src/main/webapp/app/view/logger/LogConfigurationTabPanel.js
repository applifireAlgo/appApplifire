...
Ext
		.define(
				'Healthsurvey.view.logger.LogConfigurationTabPanel',
				{
					...
					requires : [
							'Healthsurvey.view.logger.tabs.details.DetailsTab',
							'Healthsurvey.view.logger.tabs.fileconnector.FileConnectorTab',
							'Healthsurvey.view.logger.tabs.dbconnector.DBConnectorTab',
							'Healthsurvey.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab',
							'Healthsurvey.view.logger.tabs.tcpsocketconnector.TCPSocketConnectorTab',
							'Healthsurvey.view.logger.LogConfigurationTabPanelController',
