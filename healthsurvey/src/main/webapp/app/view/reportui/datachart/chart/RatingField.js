...
Ext.define('Healthsurvey.view.reportui.datachart.chart.RatingField', {
	...
	onRender: function(ct, position) {
		Healthsurvey.view.reportui.datachart.chart.RatingField.superclass.onRender.call(this, ct, position);
	 ...
	 */
	initEvents: function() {
		Healthsurvey.view.reportui.datachart.chart.RatingField.superclass.initEvents.call(this);
