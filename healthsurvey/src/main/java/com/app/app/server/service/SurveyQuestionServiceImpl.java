...
import com.app.app.server.businessservice.SurveyQuestionBusinessService;
...
public class SurveyQuestionServiceImpl extends SurveyQuestionService {
    ...
    public HttpEntity<ResponseBean> findAll() throws SpartanPersistenceException, Exception {
        ...
        java.util.List<com.app.app.shared.health.SurveyQuestion> lstsurveyquestion = surveyQuestionrepo.findAll();
    ...
    public HttpEntity<ResponseBean> findBySurveyQuestionGroupId(@RequestBody FindByBean findByBean) throws SpartanPersistenceException, Exception {
        ...
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.OK;
        try {
            List<com.app.app.shared.health.SurveyQuestion> lstsurveyquestion = surveyQuestionrepo.findBySurveyQuestionGroupId((java.lang.Integer) findByBean.getFindKey());
            responseBean.add("success", true);
            responseBean.add("message", "Successfully retrived ");
            responseBean.add("data", lstsurveyquestion);
        } catch (org.springframework.transaction.TransactionException e) {
    ...
    public HttpEntity<ResponseBean> findById(@RequestBody FindByBean findByBean) throws SpartanPersistenceException, Exception {
        ...
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.OK;
        try {
            com.app.app.shared.health.SurveyQuestion lstsurveyquestion = surveyQuestionrepo.findById((String) findByBean.getFindKey());
            responseBean.add("success", true);
            responseBean.add("message", "Successfully retrived ");
            responseBean.add("data", lstsurveyquestion);
        } catch (org.springframework.transaction.TransactionException e) {
    ...
    @RequestMapping(value = "/ChdQuestions", method = RequestMethod.POST)
    @Override
    public HttpEntity<ResponseBean> ChdQuestions() throws SpartanPersistenceException, Exception {
        com.athena.framework.server.bean.ResponseBean responseBean = new ResponseBean();
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.OK;
        java.util.List<com.app.app.shared.health.SurveyQuestion> lstsurveyquestion = surveyQuestionrepo.ChdQuestions();
        responseBean.add("success", true);
        responseBean.add("message", "Successfully retrived ");
        responseBean.add("data", lstsurveyquestion);
        return new org.springframework.http.ResponseEntity<ResponseBean>(responseBean, httpStatus);
    ...
    @RequestMapping(value = "/BehaviourQuestions", method = RequestMethod.POST)
    @Override
    public HttpEntity<ResponseBean> BehaviourQuestions() throws SpartanPersistenceException, Exception {
        com.athena.framework.server.bean.ResponseBean responseBean = new ResponseBean();
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.OK;
        java.util.List<com.app.app.shared.health.SurveyQuestion> lstsurveyquestion = surveyQuestionrepo.BehaviourQuestions();
        responseBean.add("success", true);
        responseBean.add("message", "Successfully retrived ");
        responseBean.add("data", lstsurveyquestion);
        return new org.springframework.http.ResponseEntity<ResponseBean>(responseBean, httpStatus);
    ...
    @RequestMapping(value = "/GeneralQuestions", method = RequestMethod.POST)
    @Override
    public HttpEntity<ResponseBean> GeneralQuestions() throws SpartanPersistenceException, Exception {
        com.athena.framework.server.bean.ResponseBean responseBean = new ResponseBean();
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.OK;
        java.util.List<com.app.app.shared.health.SurveyQuestion> lstsurveyquestion = surveyQuestionrepo.GeneralQuestions();
        responseBean.add("success", true);
        responseBean.add("message", "Successfully retrived ");
        responseBean.add("data", lstsurveyquestion);
        return new org.springframework.http.ResponseEntity<ResponseBean>(responseBean, httpStatus);
    ...
    public HttpEntity<ResponseBean> LifeStyleQuestions() throws SpartanPersistenceException, Exception {
        com.athena.framework.server.bean.ResponseBean responseBean = new ResponseBean();
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.OK;
        java.util.List<com.app.app.shared.health.SurveyQuestion> lstsurveyquestion = surveyQuestionrepo.LifeStyleQuestions();
        responseBean.add("success", true);
        responseBean.add("message", "Successfully retrived ");
        responseBean.add("data", lstsurveyquestion);
        return new org.springframework.http.ResponseEntity<ResponseBean>(responseBean, httpStatus);
