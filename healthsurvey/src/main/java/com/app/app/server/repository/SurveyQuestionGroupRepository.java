...
public interface SurveyQuestionGroupRepository<T> extends SearchInterface {
    ...
    public T findById(Integer surveyQuestionGroupId) throws Exception, SpartanPersistenceException;
}
