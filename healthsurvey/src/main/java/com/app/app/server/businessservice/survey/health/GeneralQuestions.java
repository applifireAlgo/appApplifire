...
public class GeneralQuestions {
    ...
    public List<SurveyQuestion> retriveGeneralQuestions() throws SpartanIncorrectDataException, Exception, SpartanBusinessValidationFailedException, SpartanPersistenceException, SpartanDataNotFoundException {
        java.util.List<com.app.app.shared.health.SurveyQuestion> surveyquestion_4 = null;
        try {
            surveyquestion_4 = surveyQuestionRepository.GeneralQuestions();
            return surveyquestion_4;
        } catch (Exception e) {
            e.printStackTrace();
