...
@Entity
@NamedQueries({ @javax.persistence.NamedQuery(name = "SurveyScore.findByUserId", query = "select e from SurveyScore e where e.systemInfo.activeStatus=1 and e.userId=:userId"), @javax.persistence.NamedQuery(name = "SurveyScore.findById", query = "select e from SurveyScore e where e.systemInfo.activeStatus=1 and e.surveyScoreId =:surveyScoreId") })
public class SurveyScore implements Serializable, CommonEntityInterface, Comparator<SurveyScore> {
    ...
    public boolean equals(Object obj) {
        try {
            com.app.app.shared.health.SurveyScore other = (com.app.app.shared.health.SurveyScore) obj;
            if (surveyScoreId == null) {
                return false;
